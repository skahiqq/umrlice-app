...
class PaymentController extends Controller
{
    public function initPayment()
    {
        ...
        try {
            $response = Http::withHeaders([
                ...
                'callbackUrl' => 'https://umrlice-api.com/api/callback'
            ]);
    ...
    public function callBackPreAuthorize()
    {
        ...
        return response()->json(Response::$statusTexts[Response::HTTP_OK])->setStatusCode(Response::HTTP_OK, Response::$statusTexts[Response::HTTP_OK]);;
    }
